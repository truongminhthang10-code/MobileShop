...
CREATE TABLE IF NOT EXISTS `carts` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `IX_Carts_UserId_VariantId` (`UserId`,`VariantId`),
...
(5, 'TRUONG MINH THANG', '0374608738', '1041/62/3/14 Trần Xuân Soạn, Khu phố 72, Phường Tân Hưng, Q.7, TP.HCM', NULL, 'COD', 'Delivery', 29000000.00, 0, '2026-05-02 09:37:36.246803', 3),
(6, 'TRUONG MINH THANG', '0374608738', '1041/62/3/14 Trần Xuân Soạn, Khu phố 72, Phường Tân Hưng, Q.7, TP.HCM', NULL, 'COD', 'Delivery', 19490000.00, 0, '2026-05-04 12:07:20.377316', 3);
...
(3, 2, 'Titan Tự Nhiên', '256GB', 29000000.00, 49, '/uploads/products/59f20682-6acd-4cf3-8b16-53ba95eae37d_iphone-15-promax-titan-tu-nhien.webp'),
...
(6, 3, 'Trắng vàng', '256GB', 19490000.00, 49, '/uploads/products/b5351639-bb76-466a-aebe-259d54cc9670_apple-ipad-air-m4-11-inch-128gb-wifi_1_1.webp'),
...
('20260504113306_AddIndexesAndUniqueConstraints', '9.0.15');
